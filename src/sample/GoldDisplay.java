...
public class GoldDisplay {
    ...
    public GoldDisplay(){
        ...
        hp.setFont(Font.font("Verdana", FontWeight.BOLD, 28));
        hp.setFill(Color.RED);
        Text lvl=new Text(bodyDimensions[0]/4,bodyDimensions[1]/8,"LVL: 1 (XP ?/?)");
        lvl.setFont(Font.font("Verdana", FontWeight.BOLD, 28));
        ...
        hp1.setFont(Font.font("Verdana", FontWeight.BOLD, 28));
        hp1.setFill(Color.RED);
        Text lvl1=new Text(bodyDimensions[0]/4,bodyDimensions[1]/3,"LVL: 1 (XP ?/?)");
        lvl1.setFont(Font.font("Verdana", FontWeight.BOLD, 28));
        ...
        num1.setFont(Font.font("Verdana", FontWeight.BOLD, 30));
